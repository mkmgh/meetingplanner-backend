...
let setRouter = (app) => {
    ...
    app.post(`${baseUrl}/createMeeting`, authentication.isAuthorized, meetingController.createMeeting);
    ...
    */
    ...
    //this is a get request for getting all meeting details of user OR admin.
    app.get(`${baseUrl}/:userId/getAllMeetings`, authentication.isAuthorized, meetingController.getAllMeetings);   
    ...
    */
    ...
    //this is a get request for getting details of the perticular meeting.
    app.get(`${baseUrl}/:meetingId/getMeeting`, authentication.isAuthorized, meetingController.getMeeting);    

    /**
         * @apiGroup Meetings
         * @apiVersion  1.0.0
         * @api {get} /api/v1/meetings/:meetingId/getMeeting To get single meeting details.
         *
    ...
    */
    ...
    app.post(`${baseUrl}/:meetingId/editMeeting`, authentication.isAuthorized, meetingController.editMeeting);
    ...
    */
    ...
    //this is a post request for deleting the meeting.
    app.post(`${baseUrl}/:meetingId/deleteMeeting`, authentication.isAuthorized, meetingController.deleteMeeting);
