...
let setRouter = (app) => {
    ...
    */
    ...
    /**
         * @apiGroup Users
         * @apiVersion  1.0.0
         * @api {get} /api/v1/users/:userId/verifyUser for the email verification of user.
         *
         * @apiParam {string} userId UserId of the user. (route params)
         *
         * @apiSuccess {object} myResponse shows error status, message, http status code, result.
         * 
         * @apiSuccessExample {object} Success-Response:
    ...
    */
    ...
    app.get(`${baseUrl}/view/allUsers` , authentication.isAuthorized, userController.getAllUsers);
    ...
    */
    ...
    app.get(`${baseUrl}/:userId/userDetails` , authentication.isAuthorized, userController.getSingleUser);
    ...
    */
    ...
    app.put(`${baseUrl}/:userId/edit`, authentication.isAuthorized, userController.editUser);
    ...
    */
    ...
    app.put(`${baseUrl}/:userId/deleteUser`, authentication.isAuthorized, userController.deleteUser);
